...
public class Trace {
	 ...
	 * This may be called multiple times to add multiple methods.
	 ...
	 */
	public static void graphvizShowStepsOf (String className, String methodName) {
	...
	public static void graphvizShowStepsOfMethod (String methodName) {
		GRAPHVIZ_SHOW_STEPS = true;
		if (GRAPHVIZ_SHOW_STEPS_OF == null)
			GRAPHVIZ_SHOW_STEPS_OF = new HashSet<>();
		GRAPHVIZ_SHOW_STEPS_OF.add (new OptionalClassNameWithRequiredMethodName (null, methodName));
	}
	protected static boolean graphvizShowStepsOfInternal (List<StackFrame> frames) {
		...
		return Trace.graphvizShowStepsOfInternal (className, methodName);
	}
	protected static boolean graphvizShowStepsOfInternal (ThreadReference thr) {
		if (GRAPHVIZ_SHOW_STEPS_OF == null) return true;
		List<StackFrame> frames = null;
		try { frames = thr.frames (); } catch (IncompatibleThreadStateException e) { }
		return Trace.graphvizShowStepsOfInternal (frames);
	}
	protected static boolean graphvizShowStepsOfInternal (String className, String methodName) {
		if (GRAPHVIZ_SHOW_STEPS_OF == null) return true;
	...
	static {
		...
		EXCLUDE_PATTERNS.add ("jdk.*");
		EXCLUDE_PATTERNS.add ("sun.*");
		EXCLUDE_PATTERNS.add ("com.*");
		EXCLUDE_PATTERNS.add ("org.*");
		EXCLUDE_PATTERNS.add ("javax.*");
		EXCLUDE_PATTERNS.add ("apple.*");
		EXCLUDE_PATTERNS.add ("stdlib.BinaryIn");
		EXCLUDE_PATTERNS.add ("stdlib.BinaryOut");
		EXCLUDE_PATTERNS.add ("stdlib.DoublingTest");
		EXCLUDE_PATTERNS.add ("stdlib.GraphvizBuilder");
		EXCLUDE_PATTERNS.add ("stdlib.GraphvizBuilder" + ".*");
		EXCLUDE_PATTERNS.add ("stdlib.GraphvizBuilder" + "$*");
		EXCLUDE_PATTERNS.add ("stdlib.In");
		EXCLUDE_PATTERNS.add ("stdlib.Out");
		EXCLUDE_PATTERNS.add ("stdlib.Picture");
		EXCLUDE_PATTERNS.add ("stdlib.ArrayGenerator");
		EXCLUDE_PATTERNS.add ("stdlib.StdAudio");
		EXCLUDE_PATTERNS.add ("stdlib.StdDraw");
		EXCLUDE_PATTERNS.add ("stdlib.StdIn");
		EXCLUDE_PATTERNS.add ("stdlib.StdInTest");
		EXCLUDE_PATTERNS.add ("stdlib.StdOut");
		EXCLUDE_PATTERNS.add ("stdlib.StdRandom");
		EXCLUDE_PATTERNS.add ("stdlib.StdStats");
		EXCLUDE_PATTERNS.add ("stdlib.Stopwatch");
		//        EXCLUDE_PATTERNS.add (stdlib.BinaryIn.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.BinaryOut.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.DoublingTest.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.GraphvizBuilder.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.GraphvizBuilder.class.getName () + ".*");
		//        EXCLUDE_PATTERNS.add (stdlib.GraphvizBuilder.class.getName () + "$*");
		//        EXCLUDE_PATTERNS.add (stdlib.In.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.Out.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.Picture.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.ArrayGenerator.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdAudio.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdDraw.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdIn.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdInTest.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdOut.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdRandom.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.StdStats.class.getName ());
		//        EXCLUDE_PATTERNS.add (stdlib.Stopwatch.class.getName ());
	 ...
	 */
	public static void graphvizShowFrameNumbers (boolean value) {
	 ...
	 */
	public static void graphvizShowNullVariables (boolean value) {
...
/* private static */class ValueMap {
	...
	private static class CallTree {
		...
		public void pop (ThreadReference thr) {
			if (!Trace.SHOW_CALL_TREE) return;
			if (!Trace.graphvizShowStepsOfInternal (thr)) return;
...
/* private static */class Graphviz {
	...
	private static void processPrimitiveAsObject (String gvName, Value val, PrintWriter out, Set<ObjectReference> visited) {
		...
		boolean success = processValueInline (true, "", val, out);
	...
	public static void drawFramesCheck (String loc, Value returnVal, Value exnVal, List<StackFrame> frames, Set<ReferenceType> staticClasses) {
		if (Trace.graphvizShowStepsOfInternal (frames))
